...
#include "../FileShow/createdialog.h"
...
QT_MOC_LITERAL(1, 13, 8), // "createok"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 21) // "on_buttonBox_accepted"

    },
    "CreateDialog\0createok\0\0on_buttonBox_accepted"
};
...
void CreateDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->createok((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (CreateDialog::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CreateDialog::createok)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CreateDialog::createok(QString _t1, QString _t2)
{
