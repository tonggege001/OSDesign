/****************************************************************************
** Meta object code from reading C++ file 'openpanel.h'
**
...
#include "../FileShow/openpanel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'openpanel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 19, 21) // "on_buttonBox_accepted"
    ...
    "OpenPanel\0changed\0\0on_buttonBox_accepted"
};
...
void OpenPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (OpenPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenPanel::changed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OpenPanel::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_OpenPanel.data,
    qt_meta_data_OpenPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
